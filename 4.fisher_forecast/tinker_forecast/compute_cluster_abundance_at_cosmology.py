...
oup_fname = '/oak/stanford/orgs/kipac/users/delon/aemulusnu_massfunction/cluster_abundance_tinker_fisher_%s_%.4f_nu_mass_ev_%.4f'%(parameter_changed, parameter_log10_rel_step_size, fiducial_cosmology['nu_mass_ev'])
